...
public class JavaFXPanelHelper
{
     ...
     */
    public static void addHelpAndPanelListeners(Node panel,
            ...
            final int screenDragButton)
    {
        ...
        panel.setOnZoom((zoomEvent) -> {
            ...
            ZoomType zoom = zoomEvent.getZoomFactor() > 1 ? ZoomType.ZOOM_IN
                    : ZoomType.ZOOM_OUT;
        ...
        panel.setOnScroll((scrollEvent) -> {
            ...
            ZoomType zoom = scrollEvent.getDeltaY() > 1 ? ZoomType.ZOOM_IN
                    : ZoomType.ZOOM_OUT;
            currTest.getCamera().zoomToPoint(mouse, zoom);
        });
