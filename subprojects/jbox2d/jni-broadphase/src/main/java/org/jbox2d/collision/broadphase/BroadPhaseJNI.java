...
public class BroadPhaseJNI implements BroadPhase
{
    ...
    {
        return createProxy(aabb.lowerBound.x,
            aabb.lowerBound.y,
            aabb.upperBound.x,
            aabb.upperBound.y,
            userData);
    ...
    private native int createProxy(float lowerX, float lowerY, float upperX,
            float upperY, Object userData);
    ...
    private native void moveProxy(int proxyId, float lowerX, float lowerY,
            float upperX, float upperY, float displaceX, float displaceY);
    ...
    private native void query(TreeCallback callback, float lowerX, float lowerY,
    ...
    private native void raycast(RaycastWrapper callback, float p1x, float p1y,
            float p2x, float p2y, float maxFraction);
