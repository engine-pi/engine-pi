...
import pi.graphics.boxes_ng.CombinedChildBox;
import pi.graphics.boxes_ng.InsetBox;
import pi.graphics.boxes_ng.TextLineBox;
import pi.graphics.boxes_ng.VerticalBox;

// Go to file:///data/school/repos/inf/java/engine-pi/subprojects/engine/src/main/java/pi/graphics/boxes/InsetBox.java
...
public class InsetBoxDemo extends Graphics2DComponent
{
    ...
    public void render(Graphics2D g)
    {
        ...
        new VerticalBox<>(defaultSettings, allSides, different).anchor(50, 400)
            .render(g)
            .debug();
    }
