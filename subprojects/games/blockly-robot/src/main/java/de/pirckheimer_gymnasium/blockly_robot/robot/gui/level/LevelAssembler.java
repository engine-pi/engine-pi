...
import de.pirckheimer_gymnasium.blockly_robot.robot.gui.map.ItemMapPainter;
...
public class LevelAssembler
{
    ...
    {
        String className = "de.pirckheimer_gymnasium.blockly_robot.jwinf.en.tasks.%s.Robot"
