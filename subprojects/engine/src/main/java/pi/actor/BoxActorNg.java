 ...
 * kann.
 */
public class BoxActorNg<T extends Box> extends Actor
{
    protected T box;
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> width(double width)
    {
        definedHeight = 0;
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> height(double height)
    {
        definedWidth = 0;
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> pixelPerMeter(double pixelPerMeter)
    {
        if (pixelPerMeter <= 0)
        {
            throw new IllegalArgumentException(
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> size(double width, double height)
    {
        if (width <= 0)
        {
            throw new IllegalArgumentException(
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> hFlip(boolean hFlip)
    {
        this.hFlip = hFlip;
        return this;
    }
    ...
    @Setter
    @ChainableMethod
    public BoxActorNg<T> vFlip(boolean vFlip)
    {
        this.vFlip = vFlip;
        return this;
    }
