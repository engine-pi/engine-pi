...
// Go to file:///data/school/repos/inf/java/engine-pi/subprojects/engine/src/test/java/pi/graphics/boxes_ng/TextBlockBoxTest.java
...
public class TextBlockBox extends TextBox
{
    ...
    @ChainableMethod
    @Override
    public TextBlockBox width(double width)
    {
        if (width < 1)
        {
    ...
    void draw(Graphics2D g)
    {
        ...
        for (TextLayoutLine line : lines)
        {
            ...
            layout.draw(g, (float) xCursor, (float) yCursor);
