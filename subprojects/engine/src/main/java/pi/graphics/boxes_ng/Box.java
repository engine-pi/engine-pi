...
public abstract class Box implements Iterable<Box>
{
    ...
    /**
     * Die <b>x</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @since 0.38.0
     */
    protected int x;
     ...
     *
     * @return Die <b>x</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @since 0.42.0
     */
    @API
    ...
    /**
     * Setzt die <b>x</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @param x Die <b>x</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @return Eine Referenz auf die eigene Instanz der Box, damit nach dem
     *     Erbauer/Builder-Entwurfsmuster die Eigenschaften der Box durch
     *     aneinander gekettete Setter festgelegt werden können, z.B.
    ...
    /**
     * Die <b>y</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @since 0.38.0
     */
    protected int y;
     ...
     *
     * @return Die <b>y</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @since 0.42.0
     */
    @Getter
    ...
    /**
     * Setzt die <b>y</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @param y Die <b>y</b>-Koordinate der linken unteren Ecke in Pixel.
     *
     * @return Eine Referenz auf die eigene Instanz der Box, damit nach dem
     *     Erbauer/Builder-Entwurfsmuster die Eigenschaften der Box durch
     *     aneinander gekettete Setter festgelegt werden können, z.B.
    ...
    /**
     * Setzt die <b>x</b>- und <b>y</b>-Koordinate der linken unteren Ecke in
     * Pixel.
     *
     * @param x Die <b>x</b>-Koordinate der linken unteren Ecke in Pixel.
     * @param y Die <b>y</b>-Koordinate der linken unteren Ecke in Pixel.
    ...
    /**
     * Berechnet rekursiv alle <b>Ankerpunkte</b> (linkes unteres Eck) der
     ...
     * </p>
     *
     * @param clean Wenn {@code true}, dann wird die Ausgabe bereinigt.
     *
