...
public class MotorJoint extends Joint
{
    ...
    public void solveVelocityConstraints(SolverData data)
    {
        ...
        // Solve linear friction
        {
            ...
            // m_correctionFactor *
            // m_linearError;
            Cdot.x = vB.x + -wB * m_rB.y - vA.x - -wA * m_rA.y
                    + inv_h * m_correctionFactor * m_linearError.x;
            Cdot.y = vB.y + wB * m_rB.x - vA.y - wA * m_rA.x
                    + inv_h * m_correctionFactor * m_linearError.y;
