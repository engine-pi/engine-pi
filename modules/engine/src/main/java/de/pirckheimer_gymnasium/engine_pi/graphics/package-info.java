 ...
 * <p>
 * Die
 * {@link de.pirckheimer_gymnasium.engine_pi.actor.Actor#render(java.awt.Graphics2D, double)}-Methode
 * der {@link de.pirckheimer_gymnasium.engine_pi.actor.Actor Actor}-Klasse
 * bietet beispielsweise Zugriff auf das {@link java.awt.Graphics2D
 * Graphics2D}-Objekt:
 * </p>
 *
 * <pre>{@code
 ...
 * <p>
 * Wir nutzen den
 * {@link de.pirckheimer_gymnasium.engine_pi.resources.ImageContainer
 * Bildspeicher} um ein Bild zu laden:
 * </p>
 *
 * <pre>{@code
