 ...
 * @since 0.34.0
 */
public class Text extends pi.actor.Text implements InstantActor
{
     ...
     *
     * @see pi.actor.Text#Text(String, double)
     ...
     *
     * @see pi.actor.Text#Text(String, double, String)
     ...
     *     </ul>
     *
     * @see pi.actor.Text#Text(String, double, String, int)
