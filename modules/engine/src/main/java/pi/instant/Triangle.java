 ...
 * @since 0.33.0
 */
public class Triangle extends pi.actor.Triangle implements InstantActor
{
     ...
     *
     * @see pi.actor.Triangle#Triangle()
     ...
     *
     * @see pi.actor.Triangle#Triangle(double)
     ...
     *
     * @see pi.actor.Triangle#Triangle(double, double)
     ...
     *
     * @see pi.actor.Triangle#Triangle(double, double, double, double, double,
     *     double)
     ...
     *
     * @see pi.actor.Triangle#Triangle(Vector, Vector, Vector)
