 ...
 * @since 0.42.0
 */
public class ChildsContainerBox<T extends Box> extends Box
{
    /**
     * @since 0.42.0
     */
    public ChildsContainerBox(Box... childs)
    {
    ...
    public ChildsContainerBox<T> forEachChild(Consumer<T> consumer)
    {
        for (Box box : childs)
        {
