package de.pirckheimer_gymnasium.blockly_robot.robot.utils;
...
import de.pirckheimer_gymnasium.blockly_robot.jwinf.en.tasks.conditionals_excercises.find_the_destination.Robot;
...
class PackageClassLoaderTest
{
            ...
            throws ReflectiveOperationException
    {
        ...
        assertEquals(sampleClass.getClass().getName(),
                "de.pirckheimer_gymnasium.blockly_robot.jwinf.en.tasks.conditionals_excercises.find_the_destination.Robot");
    }
