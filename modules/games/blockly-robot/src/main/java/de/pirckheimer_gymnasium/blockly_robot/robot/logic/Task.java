package de.pirckheimer_gymnasium.blockly_robot.robot.logic;

import java.io.IOException;
import java.util.List;
import java.util.Map;

import de.pirckheimer_gymnasium.blockly_robot.robot.data.JsonLoader;
import de.pirckheimer_gymnasium.blockly_robot.robot.data.model.BagInit;
