/*
 * Source: https://github.com/engine-alpha/engine-alpha/blob/4.x/engine-alpha/src/main/java/ea/internal/util/Logger.java
 *
...
final public class Logger
{
    ...
    {
        if (de.pirckheimer_gymnasium.engine_pi.Game.isVerbose())
        {
            StackTraceElement e = Thread.currentThread().getStackTrace()[2];
